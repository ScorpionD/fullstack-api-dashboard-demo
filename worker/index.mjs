  ...
  async fetch(request, env) {
    ...
    if (url.origin !== env.PUBLIC_ORIGIN)
      return reply(
        403,
        "ORIGIN_DENIED",
        "This API is only available on the production demo.",
      );
    ...
    if (
      ...
      return reply(403, "ORIGIN_DENIED", "This origin is not allowed.");
    ...
    try {
      const response = await env.PRIVATE_API.fetch(
        new Request("http://atlas-api" + url.pathname + url.search, {

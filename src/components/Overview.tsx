...
import type { Overview as OverviewData, View } from "../types";
import { Loading, ErrorPanel, Badge, currency, date } from "./ui";
export function Overview({ navigate }: { navigate: (v: View) => void }) {
    ...
    <>
      <div className="section-header">
        <div>
          ...
          <p>A clear view of your customers, orders and business activity.</p>
        </div>

...
export function mapOrder(row){return{id:row.id,customerId:row.customer_id,customerName:row.customerName,company:row.company,reference:row.reference,description:row.description,amountCents:row.amount,status:row.status,createdAt:row.created_at};}

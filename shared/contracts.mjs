...
export const orderSchema=z.object({customerId:z.uuid(),description:z.string().trim().min(2).max(120),amountCents:z.number().int().min(1).max(100000000),status:z.enum(['pending','processing','completed','cancelled'])}).strict();

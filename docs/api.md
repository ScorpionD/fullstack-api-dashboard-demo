...
```json
{"name":"Alex Morgan","email":"alex@example.com","company":"Demo Studio","status":"active"}
```

Order:

```json
{"customerId":"UUID of a customer in this workspace","description":"API integration sprint","amountCents":123456,"status":"pending"}
```
...
```json
{"error":{"code":"VALIDATION_ERROR","message":"Please check the submitted fields.","requestId":"server-generated UUID","fields":{"amountCents":"Validation explanation"}}}
```
